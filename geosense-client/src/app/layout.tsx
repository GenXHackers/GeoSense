...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        <div className=" h-[100dvh] w-[100dvw] overflow-y-auto overflow-x-hidden">
          {children}
        </div>
        <div className="bg-teal-800 text-slate-200 font-semibold text-lg flex items-center p-4 rounded-t-lg absolute bottom-0 inset-x-0 shadow-lg">
